...
QString buildApplicationStyleSheet()
{
    return QStringLiteral(
        ...
        "QToolBar#mainToolBar QComboBox { min-height: 24px; max-height: 24px; }"
        ...
        "QLineEdit#serverFilterEdit, QLineEdit#logFilterEdit { background: #ffffff; border: 1px solid #c8c8c8; border-radius: 0px; min-height: 22px; max-height: 22px; padding: 0 8px; }"
