...
QString buildApplicationStyleSheet()
{
    return QStringLiteral(
        ...
        "QToolBar#mainToolBar { background: #ffffff; border: none; border-bottom: 1px solid #dddddd; spacing: 0px; padding: 6px 8px; }"
        ...
        "QToolBar#mainToolBar QToolButton#coreToggleButton, QToolBar#mainToolBar QToolButton#proxyToggleButton { border: 1px solid #bdbdbd; padding: 4px 8px; }"
        "QToolBar#mainToolBar QToolButton#coreToggleButton:hover, QToolBar#mainToolBar QToolButton#proxyToggleButton:hover { border: 1px solid #9f9f9f; }"
        ...
        "QToolBar#mainToolBar QComboBox#routingModeCombo { min-height: 27px; }"
