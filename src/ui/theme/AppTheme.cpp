...
QString buildApplicationStyleSheet()
{
    return QStringLiteral(
        ...
        "QTabBar#settingsTabBar::tab { background: transparent; color: #808080; padding: 6px 24px; margin: 0px 0px 1px 0px; border: none; }"
        "QTabBar#settingsTabBar::tab:selected { background: #111111; color: #ffffff; font-weight: 600; }"
        "QTabBar#settingsTabBar::tab:hover:!selected { background: #dddddd; color: #222222; }"
        "QWidget#subscriptionTabBarContainer { background: transparent; border: none; border-bottom: 1px solid #777777; }"
        "QTabBar#subscriptionTabBar { background: transparent; border: none; }"
        "QTabBar#subscriptionTabBar::tab { background: transparent; color: #808080; font-weight: 400; padding: 6px 24px; margin: 0px; border: none; border-bottom: 2px solid transparent; }"
        ...
        "#serverHeaderRow { background: #ffffff; }"
        ...
        "#logHeaderRow { background: transparent; border: none; border-bottom: 1px solid #000000; }"
