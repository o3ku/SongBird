...
constexpr ThemePalette kLightPalette{
    ...
    .navigationSelectedBackground = "#b7dec9",
    .navigationSelectedText = "#1f2328",
    .navigationSelectedBorder = "#2f6d56",
    ...
    .serverSelectedBackground = "#e6f0eb",
...
constexpr ThemePalette kDarkPalette{
    ...
    .navigationSelectedBackground = "#40785e",
    .navigationSelectedText = "#edf1f6",
    .navigationSelectedBorder = "#86d49c",
    ...
    .serverSelectedBackground = "#264838",
