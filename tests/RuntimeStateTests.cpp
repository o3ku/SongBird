...
void RuntimeStateTests::applySnapshotEmitsOnlyChangedGroups()
{
    ...
    QSignalSpy coreStateSpy(&state, &RuntimeState::coreStateChanged);
    ...
    snapshot.coreProcessRunning = true;
    snapshot.coreTransitionPending = true;
